...
<div class="input-group form-group" style="background-color:#FFC312;margin:0 0 10px 0; border:1px solid black;">
                    ...
                    <div class="input-group form-group" style="background-color:#FFC312;margin:0 0 10px 0; border:1px solid black;">
                            ...
                            <input style="border:1px solid black;"type="date" id="start" name="rok" value="2022-01-01" min="2022-01-01" max="2022-12-31">
                            </div>      

  <button type="submit" class="btn btn-danger" name="add_new" style="border:2px solid black;margin:30px 0 0 0;">Postavi oglas</button>
  </div>
</form>
</div>
</section>
